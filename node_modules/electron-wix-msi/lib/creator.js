...
class MSICreator {
    ...
    createWxs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const scaffoldReplacements = {
                ...
                '<!-- {{ShortcutProperties}} -->': shortcutProperties.map(({ key, value }) => this.getShortcutProperty(key, value)).join('\n'),
            };
            const replacements = {
    ...
    getShortcutProperty(key, value) {
        const xml = replace_1.replaceInString(this.shortcutPropertyTemplate, {
